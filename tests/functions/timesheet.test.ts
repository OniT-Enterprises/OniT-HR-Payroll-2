...
function createMockShift(date: string, start: string, end: string, hours?: number) {
  return {
...
describe('Timesheet Computation', () => {
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    test('handles weeks spanning multiple months', async () => {
      ...
      mockCollection.get
        .mockResolvedValueOnce({ docs: [{ data: () => createMockShift('2024-01-30', '09:00', '17:00') }] })
        .mockResolvedValueOnce({ docs: [{ data: () => createMockShift('2024-02-01', '09:00', '17:00') }] });
